...
public sealed class NumberConstraintsBuilder<TEntity, TProperty> where TEntity : class where TProperty : INumber<TProperty>
{
	...
	public NumberConstraintsBuilder<TEntity, TProperty> NumberInBetween(TProperty min, TProperty max) => NumberInBetween(_builder.CreateUniqueConstraintName(_columnName, nameof(NumberInBetween)), min, max);
	...
	public NumberConstraintsBuilder<TEntity, TProperty> NumberMin(TProperty min) => NumberMin(_builder.CreateUniqueConstraintName(_columnName, nameof(NumberMin)), min);
	...
	public NumberConstraintsBuilder<TEntity, TProperty> NumberMax(TProperty max) => NumberMax(_builder.CreateUniqueConstraintName(_columnName, nameof(NumberMax)), max);
	...
	public NumberConstraintsBuilder<TEntity, TProperty> EqualOneOf(IEnumerable<TProperty?> acceptedValues) => EqualOneOf(_builder.CreateUniqueConstraintName(_columnName, nameof(EqualOneOf)), acceptedValues);
