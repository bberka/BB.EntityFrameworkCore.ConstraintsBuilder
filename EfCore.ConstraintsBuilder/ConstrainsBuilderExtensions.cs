...
public static class ConstrainsBuilderExtensions
{
 ...
 internal static ConstraintsBuilder<TEntity> AddConstraintsFor<TEntity>(this EntityTypeBuilder<TEntity> builder,
                                                                                 string name,
                                                                                 SupportedConstraintServerType serverType = SupportedConstraintServerType.SqlServer) where TEntity : class {
   return new ConstraintsBuilder<TEntity>(builder, name, serverType);
 }
