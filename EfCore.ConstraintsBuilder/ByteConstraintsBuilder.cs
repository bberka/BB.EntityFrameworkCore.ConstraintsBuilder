...
public sealed class ByteConstraintsBuilder<TEntity> where TEntity : class
{
  ...
  public ByteConstraintsBuilder<TEntity> NumberInBetween(byte min, byte max)  => NumberInBetween(_builder.CreateUniqueConstraintName(_columnName, nameof(NumberInBetween)), min, max);
  ...
  public ByteConstraintsBuilder<TEntity> NumberMin(byte min)  => NumberMin(_builder.CreateUniqueConstraintName(_columnName, nameof(NumberMin)), min);
  ...
  public ByteConstraintsBuilder<TEntity> EqualOneOf(IEnumerable<byte> acceptedValues)  => EqualOneOf(_builder.CreateUniqueConstraintName(_columnName, nameof(EqualOneOf)), acceptedValues);
